...
#define CAEN_COMM_VERSION_MINOR			8																																//!< Minor version
...
typedef enum CAENCOMM_INFO {
	CAENComm_PCI_Board_SN			= 0,		//!< S/N of the CONET master board (only on A2818 and A4818)
	CAENComm_PCI_Board_FwRel		= 1,		//!< Firmware Release of the CONET master board (only on A2818 and A4818)
	CAENComm_VME_Bridge_SN			= 2,		//!< S/N of the VME bridge
	CAENComm_VME_Bridge_FwRel1		= 3,		//!< Firmware Release for the VME bridge
	CAENComm_VME_Bridge_FwRel2		= 4,		//!< Firmware Release for the optical chipset inside the VME bridge (V2718 only), not available if ConetNode != 0
...
* \param[out] VMEHandle: The CAEN Bridge handle to use in VMEIRQCheck and VMEIACKCycle.
* \return     0 = Success; negative numbers are error codes
******************************************************************************/
