...
typedef enum CVBoardTypes {
	...
	// V2718
	cvV2718						= 1,	//!< A2818/A3818/A5818 to V2718 @note Valid also for other CAEN bridges and direct link to digitizers
	cvUSB_A4818_V2718_LOCAL		= 5,	//!< A4818 to V2718 internal registers @warning Experts only @since v3.2.0
	cvUSB_A4818_V2718			= 6,	//!< A4818 to V2718 @note Valid also for other CAEN bridges and direct link to digitizers @since v3.2.0
